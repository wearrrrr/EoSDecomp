...
void * __cdecl _memcpy_0(void *_Dst,void *_Src,size_t _Size)

{
  ...
  if ((_Src < _Dst) && (_Dst < (void *)(_Size + (int)_Src))) {
    ...
    if (((uint)puVar4 & 3) == 0) {
      ...
      if (7 < uVar1) {
        ...
        case 0:
          return _Dst;
        case 2:
          goto switchD_0045d18b_caseD_2;
        case 3:
          goto switchD_0045d18b_caseD_3;
        }
        goto switchD_0045d18b_caseD_1;
      }
    }
    else {
      switch(_Size) {
      case 0:
        goto switchD_0045d18b_caseD_0;
      case 1:
        goto switchD_0045d18b_caseD_1;
      case 2:
        goto switchD_0045d18b_caseD_2;
    ...
    switch(uVar2) {
    case 1:
switchD_0045d18b_caseD_1:
      *(undefined *)((int)puVar4 + 3) = *(undefined *)((int)puVar3 + 3);
      return _Dst;
    case 2:
switchD_0045d18b_caseD_2:
      *(undefined *)((int)puVar4 + 3) = *(undefined *)((int)puVar3 + 3);
      *(undefined *)((int)puVar4 + 2) = *(undefined *)((int)puVar3 + 2);
      return _Dst;
    case 3:
switchD_0045d18b_caseD_3:
      *(undefined *)((int)puVar4 + 3) = *(undefined *)((int)puVar3 + 3);
      *(undefined *)((int)puVar4 + 2) = *(undefined *)((int)puVar3 + 2);
      *(undefined *)((int)puVar4 + 1) = *(undefined *)((int)puVar3 + 1);
      return _Dst;
    }
switchD_0045d18b_caseD_0:
    return _Dst;
  }
  ...
  if (((uint)_Dst & 3) == 0) {
    ...
    if (7 < uVar1) {
      ...
      case 0:
        return _Dst;
      case 2:
        goto switchD_0045d005_caseD_2;
      case 3:
        goto switchD_0045d005_caseD_3;
      }
      goto switchD_0045d005_caseD_1;
    }
  }
  else {
    switch(_Size) {
    case 0:
      goto switchD_0045d005_caseD_0;
    case 1:
      goto switchD_0045d005_caseD_1;
    case 2:
      goto switchD_0045d005_caseD_2;
  ...
  switch(uVar2) {
  case 1:
switchD_0045d005_caseD_1:
                    /* WARNING: Load size is inaccurate */
    *(undefined *)puVar3 = *_Src;
    return _Dst;
  case 2:
switchD_0045d005_caseD_2:
                    /* WARNING: Load size is inaccurate */
    *(undefined *)puVar3 = *_Src;
    *(undefined *)((int)puVar3 + 1) = *(undefined *)((int)_Src + 1);
    return _Dst;
  case 3:
switchD_0045d005_caseD_3:
                    /* WARNING: Load size is inaccurate */
    *(undefined *)puVar3 = *_Src;
    *(undefined *)((int)puVar3 + 1) = *(undefined *)((int)_Src + 1);
